...
contract Gateway_notary is Owned {
    ...
    event DepositByAdmin(address user, address tokenAddr, uint256 amountOrId);
    ...
    // 20
    function deposit20ByAdmin(uint256 amount, address erc20Address)   
        public
        onlyAdmins
    {
        require(erc20Address.isContract());
        ...
        emit DepositByAdmin(msg.sender, erc20Address, amount);
    }

    // 721
    function deposit721ByAdmin(uint256 tokenId, address erc721Address)
        public
        onlyAdmins
    {
        require(erc721Address.isContract());
        ...
        emit DepositByAdmin(msg.sender, erc721Address, tokenId);
    }    
